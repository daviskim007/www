...
// All the codes must be here to prevent to change the global variables without the Facebook function because they are asynchronous calls.
function init() {
	...
	$('.play-button').onclick(function () {closeIntroPopin()});
	$('.but-game').onclick(function () {openGame()});
	$('.but-highscore').onclick(function () {openHighscore()});
	...
	function initialise() {
		...
		// targeting container
		for (var i = 0; i < 20; i++) {
			var card = "<div class='flip-card'><div class='flip-card-inner' id='card" + i + "'><" +
		...
		$('#card0').onclick(function () {selectCard(0, cardContent[0])});
		$('#card1').onclick(function () {selectCard(1, cardContent[1])});
		$('#card2').onclick(function () {selectCard(2, cardContent[2])});
		$('#card3').onclick(function () {selectCard(3, cardContent[3])});
		$('#card4').onclick(function () {selectCard(4, cardContent[4])});
		$('#card5').onclick(function () {selectCard(5, cardContent[5])});
		$('#card6').onclick(function () {selectCard(6, cardContent[6])});
		$('#card7').onclick(function () {selectCard(7, cardContent[7])});
		$('#card8').onclick(function () {selectCard(8, cardContent[8])});
		$('#card9').onclick(function () {selectCard(9, cardContent[9])});
		$('#card10').onclick(function () {selectCard(10, cardContent[10])});
		$('#card11').onclick(function () {selectCard(11, cardContent[11])});
		$('#card12').onclick(function () {selectCard(12, cardContent[12])});
		$('#card13').onclick(function () {selectCard(13, cardContent[13])});
		$('#card14').onclick(function () {selectCard(14, cardContent[14])});
		$('#card15').onclick(function () {selectCard(15, cardContent[15])});
		$('#card16').onclick(function () {selectCard(16, cardContent[16])});
		$('#card17').onclick(function () {selectCard(17, cardContent[17])});
		$('#card18').onclick(function () {selectCard(18, cardContent[18])});
		$('#card19').onclick(function () {selectCard(19, cardContent[19])});
